<nav x-data="{ open: false }" class="bg-base-300 border-b-4 border-base-300">
    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex text-accent">
            ...
            <div class="flex justify-end items-center">
                <select data-choose-theme
                    class="bg-base-100 border border-gray-300 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 cursor-pointer">
                        ...
                        <x-slot name="trigger">
                            <button
                                ...
                                <div class="flex items-center h-auto">
                                    ...
                                    <div class="text-base text-base-conent ml-2">{{ Auth::user()->name }}</div>
                                    <div class="ms-1">
